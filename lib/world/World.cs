...
public class World
{
    ...
    {
        Player = player;
        _monsterSpawner = new MonsterSpawner(Player, 2d, offscreenDistance: -100);

        Items.Add(new DroppedItem(new AugmentingCore(), new(0, 0)));
        Items.Add(new DroppedItem(new Hood(), new(50, 50)));
        ...
        Actors.Add(Player);
        Actors.Add(new Skeleton(1) { Position = new(120, 100) });
        Actors.Add(new CasterSkeleton(2) { Position = new(220, 220) });
    }
