...
public class SkeletonGraphicsComponent
{
    ...
    public void Update(Skeleton monster, GameTime gameTime)
    {
    ...
    public void Draw(Skeleton monster, SpriteBatch spriteBatch)
    {
        ...
        string monsterHealth = $"{Math.Floor(monster.Stats.Health)}";
